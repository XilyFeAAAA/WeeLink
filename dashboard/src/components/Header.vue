<template>
    <div class="header-container">
        ...
        <div class="tool-bar">
            ...
            <t-dropdown :options="options" trigger="click" :minColumnWidth="150">
                <div class="profile">
                    <div class="user-img">
        ...
        <template #body>
            <div class="reset-container">
                ...
                <div class="reset-body">
                    <t-form ref="formRef" :data="formData" :label-width="0" @submit="onSubmit">
...
const options = [
    {
        content: "修改密码",
        value: 1,
        onClick: () => {visibleModal.value = !visibleModal.value}
    },
    {
        content: "退出账户",
        value: 2,
